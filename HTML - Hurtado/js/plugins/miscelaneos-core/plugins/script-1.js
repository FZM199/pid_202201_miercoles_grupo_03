...
!(function (T) {
  var a = !0;
  (T.miscelaneos_flexslider = function (p, e) {
    var m = T(p);
    m.vars = T.extend({}, T.miscelaneos_flexslider.defaults, e);
    var t,
      v = m.vars.namespace,
      f =
        window.navigator &&
      ...
      w = "" !== m.vars.asNavFor,
      b = {};
    T.data(p, "miscelaneos_flexslider", m),
      (b = {
        init: function () {
          (m.animating = !1),
                ...
                ? (p._slider = m).slides.each(function () {
                    ...
                    (e._gesture = new MSGesture()),
                      ...
                      e.addEventListener("MSGestureTap", function (e) {
                        ...
                        var t = T(this),
                          a = t.index();
                        T(m.vars.asNavFor).data("miscelaneos_flexslider")
                          .animating ||
                          t.hasClass("active") ||
        ...
        sync: function (e) {
          var t = T(m.vars.sync).data("miscelaneos_flexslider"),
            a = m.animatingTo;
          switch (e) {
            case "animate":
      ...
      (m.flexAnimate = function (e, t, a, n, s) {
        if (
          ...
          if (w && n) {
            var r = T(m.vars.asNavFor).data("miscelaneos_flexslider");
            if (
    ...
    (T.miscelaneos_flexslider.defaults = {
      namespace: "flex-",
      selector: ".slides > li",
      animation: "fade",
      easing: "swing",
    ...
    (T.fn.miscelaneos_flexslider = function (n) {
      if ((void 0 === n && (n = {}), "object" == typeof n))
        return this.each(function () {
          ...
          (1 === a.length && !0 === n.allowOneSlide) || 0 === a.length
            ...
            : void 0 === e.data("miscelaneos_flexslider") &&
              new T.miscelaneos_flexslider(this, n);
        });
      var e = T(this).data("miscelaneos_flexslider");
      switch (n) {
        case "play":
          e.play();
          break;
